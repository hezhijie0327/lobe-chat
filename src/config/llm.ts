...
export const getLLMConfig = () => {
  return createEnv({
    ...
    runtimeEnv: {
      ...
      ENABLED_CLOUDFLARE:
        !!process.env.CLOUDFLARE_API_KEY && !!process.env.CLOUDFLARE_BASE_URL_OR_configOUNT_ID,
      CLOUDFLARE_API_KEY: process.env.CLOUDFLARE_API_KEY,
      CLOUDFLARE_BASE_URL_OR_configOUNT_ID: process.env.CLOUDFLARE_BASE_URL_OR_configOUNT_ID,
