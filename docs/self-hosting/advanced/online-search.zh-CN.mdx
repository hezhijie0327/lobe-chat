...
| `brave` | [Brave Search API](https://search.brave.com/help/api)，隐私友好的搜索源。 | `BRAVE_API_KEY` |
| `exa` | [Exa Search](https://exa.ai/)，面向 AI 的搜索 API。 | `EXA_API_KEY` |
...
| `tavily` | [Tavily Search API](https://www.tavily.com/)，快速网页摘要与答案返回。 | `TAVILY_API_KEY` |
