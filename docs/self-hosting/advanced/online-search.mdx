...
| `brave`      | [Brave Search API](https://search.brave.com/help/api), a privacy-friendly search source. | `BRAVE_API_KEY`                             |
| `exa`        | [Exa Search](https://exa.ai/), a search API designed for AI.                             | `EXA_API_KEY`                               |
...
| `tavily`     | [Tavily Search API](https://www.tavily.com/), offers fast web summaries and answers.     | `TAVILY_API_KEY`                            |
