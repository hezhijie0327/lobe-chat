...
> * `0`: Disable ad blocking (default behavior).

> ✅ It is recommended to use with `BROWSERLESS_STEALTH_MODE=true` to enhance stealth and scraping success rate.
...
> * `0`: Disable stealth mode (default behavior).
